...
//   const [kycsTypes, setKycsTypes] = useState<KYC[]>([]);
...
//   const handleEdit = (selectedRows: Row<KYC>[]) => {
//     navigate(`/administration/app-settings/${selectedRows}`);
//   };

//   const handleCopy = (selectedRows: Row<KYC>[]) => {
//     localStorage.setItem("settings", JSON.stringify(selectedRows[0].original));
//     navigate(from, { replace: true });
//   };
//   const [deleteAppSetting] = useMutation(DELETE_APP_SETTING);

//   const deleteRows = async (selectedRows: Row<KYC>[]) => {
...
//   const handleDelete = async (selectedRows: Row<KYC>[]) => {
//     try {
//       toast({
...
//               <p>Error: {error}</p>
//             ) : (
//               <DataTable columns={columns} data={kycsTypes} />
//             )}
//           </div>
//         </div>
//       </div>
