      ...
      >
        ...
        <div>
          ...
          {errors.localBankCode && (
            <span className="text-red-500">{errors.localBankCode.message}</span>
          )}
        </div>
        <div>
        ...
        <div>
          ...
          />
          {errors.buildingName && (
            <span className="text-red-500">{errors.buildingName.message}</span>
          )}
        </div>
        <div>
          ...
          {errors.postalAddress && (
            <span className="text-red-500">{errors.postalAddress.message}</span>
          )}
        </div>
        <div>
        ...
        <Button type="submit" size="lg" className="bg-[#36459C] hover:bg-[#253285]">Submit</Button>
